...
async def rgservidor(ctx):
		...
		if rpg is None:
			servidor = {"_id":str(ctx.guild.id),"usuario":str(ctx.guild.name), "canalwel_id":0,"canallogs_id":0, "canalbye_id":0,"welcome":False,"adeus":False,"logs":False, "a":False, "b":False}
