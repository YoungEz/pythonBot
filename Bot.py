	...
	if ctx.invoked_subcommand is None:
		try:
			...
			if rpg is None:
				...
				if canallogs == 0:
					canaal = "Canal dão definido use `s!config bemvindo #canal` para definir"
				else:
